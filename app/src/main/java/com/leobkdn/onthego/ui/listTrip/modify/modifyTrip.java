...
public class modifyTrip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_trip_info);
        ...
        listDestinations.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Intent intent = new Intent(modifyTrip.this, DestinationInfo.class);
    ...
    private void setupNotification(){
        ...
        if (minI >= 0 && destinations.get(minI).getFinishTime() != null) {
            Intent intent = new Intent(modifyTrip.this, Reminder.class);
            PendingIntent pendingIntent = PendingIntent.getBroadcast(modifyTrip.this, 69, intent, PendingIntent.FLAG_UPDATE_CURRENT);
