...
public class addTrip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listDestinations.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Intent intent = new Intent(addTrip.this, DestinationInfo.class);
    ...
    private void setupNotification(){
        ...
        if (minI >= 0 && destinations.get(minI).getFinishTime() != null) {
            Intent intent = new Intent(addTrip.this, Reminder.class);
            PendingIntent pendingIntent = PendingIntent.getBroadcast(addTrip.this, 69, intent, PendingIntent.FLAG_UPDATE_CURRENT);
